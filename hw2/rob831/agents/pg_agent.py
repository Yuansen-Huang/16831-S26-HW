...
class PGAgent(BaseAgent):
    ...
    def train(self, observations, actions, rewards_list, next_observations, terminals):
        ...
        train_log = self.actor.update(observations, actions, advantages, q_values=None)
    ...
    def estimate_advantage(self, obs, rewards_list, q_values, terminals):
        ...
        if self.nn_baseline:
            ...
            values = unnormalize(values_normalized, mean_q, std_q)
    ...
    def _discounted_return(self, rewards):
        ...
        discounted_returns = np.ones_like(rewards) * discounted_return
